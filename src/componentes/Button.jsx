    ...
    <StyledWrapper>
      <div className="loader">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" height={64} width={64} className="inline-block">
          <path strokeLinejoin="round" strokeLinecap="round" strokeWidth={8} stroke="url(#b)" d="M 54.722656,3.9726563 A 2.0002,2.0002 0 0 0 54.941406,4 h 5.007813 C 58.955121,17.046124 49.099667,27.677057 36.121094,29.580078 a 2.0002,2.0002 0 0 0 -1.708985,1.978516 V 60 H 29.587891 V 31.558594 A 2.0002,2.0002 0 0 0 27.878906,29.580078 C 14.900333,27.677057 5.0448787,17.046124 4.0507812,4 H 9.28125 c 1.231666,11.63657 10.984383,20.554048 22.6875,20.734375 a 2.0002,2.0002 0 0 0 0.02344,0 c 11.806958,0.04283 21.70649,-9.003371 22.730469,-20.7617187 z" className="dash" id="c" pathLength={360} />
        </svg>
        ...
        m 0 -27
        a 27 27 0 1 1 0 54
        a 27 27 0 1 1 0 -54" className="spin" id="a" pathLength={360} />
        </svg>
        <div className="w-2" /> 
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" style={{rotationDuration: '0ms', rotationDirection: 'normal'}} viewBox="0 0 64 64" height={64} width={64} className="inline-block">
         ...
         <p className="bg-amber-300"><span> SI TE INTERESA PARTICIPAR DEL EVENTO PODES COMUNICARTE POR WHATSAPP AL +54 9 2945 525009</span></p>
